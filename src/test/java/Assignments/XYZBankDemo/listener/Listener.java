package Assignments.XYZBankDemo.listener;
...
import static Assignments.XYZBankDemo.utils.DriverUtil.getDriver;
...
public class Listener implements ITestListener {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        try {
            ...
            File destFile = new File((String) reportDirectory + "\\XYZ_Bank_ScreenShots\\" + methodName + "_" + formatter.format(calendar.getTime()) + ".png");
